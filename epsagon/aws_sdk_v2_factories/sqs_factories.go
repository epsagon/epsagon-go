...
// SqsEventDataFactory creates an Epsagon Resource from aws.Request
func SqsEventDataFactory(r *aws.Request, res *protocol.Resource, metadataOnly bool) {
...
func handleSQSSendMessage(r *aws.Request, res *protocol.Resource, metadataOnly bool) {
...
func handleSQSReceiveMessage(r *aws.Request, res *protocol.Resource, metadataOnly bool) {
